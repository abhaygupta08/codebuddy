...
export default function Config({
  ...
  return (
    <div className='relative w-full'>
      <div className='absolute z-10 flex items-center justify-between w-10/12 gap-4 right-2 top-2'>
        <div>
          <img
          title='Toggle Input/Output'
            src={LeftArrow}
            className={
              ioVisible ? 'transform -rotate-90 cursor-pointer' : 'transform rotate-90 cursor-pointer'
            }
