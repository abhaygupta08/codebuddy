...
export default function Navbar() {
  ...
  const DefaultRoutes = [
    ...
    {
      navDisplay : <img src={UserImg} alt='UserImg' width={'20px'} height={'20px'} />,
      path : '/account',
    }
  ]
  ...
  const UserRoutes = [
    ...
    {
      navDisplay : <div className='flex gap-0.5'><img src={UserImg} alt='UserImg' width={'20px'} height={'20px'} /> {auth?.username}</div>,
      path : '/user',
    },
    {
      navDisplay : 'Logout',
